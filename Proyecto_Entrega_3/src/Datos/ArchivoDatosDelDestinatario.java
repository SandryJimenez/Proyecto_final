 ...
 * @author JULIO
 */
public class ArchivoDatosDelDestinatario  {
    
    File Archivo;
    private FileWriter A_Escritura;
    private Scanner A_Lectura;

    public ArchivoDatosDelDestinatario() {
        
        this.Archivo = new File("DatosDelDestinatario.dat");
    }

    public ArchivoDatosDelDestinatario(String Name) {
    ...
    public boolean Escribir (DatosDelDestinatarioR H) throws IOException{
    ...
    public DatosDelDestinatarioR LeerDatosDelDestinatarioR (String linea[]){
        DatosDelDestinatarioR H = new DatosDelDestinatarioR();
        ...
        H.setCodigoPostal(Integer.valueOf(linea[4]));
        return H;
    }
    ...
    public List<DatosDelDestinatarioR> Leer() throws IOException{
        ...
        List<DatosDelDestinatarioR> lista = null;
        ...
        try {
            ...
            while(this.A_Lectura.hasNext()){
                ...
                DatosDelDestinatarioR H = this.LeerDatosDelDestinatarioR(linea);
                lista.add(H);
            }
            return lista;
    ...
    public DatosDelDestinatarioR Eliminar(String NombreCompletos) throws IOException{ // 123
        

        DatosDelDestinatarioR eliminado = null;
        List<DatosDelDestinatarioR> listadoDatosDelDestinatarioR = this.Leer();
        ArchivoDatosDelDestinatario archivoTmp = new ArchivoDatosDelDestinatario("ListaDatosDelDestinatarioTmp.dat");
        for (DatosDelDestinatarioR H : listadoDatosDelDestinatarioR) {
    ...
    public DatosDelDestinatarioR buscar(String NombreC) throws IOException{
        DatosDelDestinatarioR Buscado1 = null;
        
        try{
            this.A_Lectura = new Scanner(this.Archivo);
            while(this.A_Lectura.hasNext()){
                DatosDelDestinatarioR H = this.LeerDatosDelDestinatarioR(this.A_Lectura.nextLine().split(";"));
